...
export const PRODUCT_FILTER_SEARCH = "PRODUCT_FILTER_SEARCH";
...
export const product_search_filter=(payload)=>({type:PRODUCT_SEARCH_FILTER, payload})
export const product_filter_search=(payload)=>({type:PRODUCT_FILTER_SEARCH, payload})
